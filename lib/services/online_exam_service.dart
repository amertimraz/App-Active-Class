...
class OnlineExamService {
  ...
  // ملاحظة: رفع صور الأسئلة (spec 019) بيتم عبر خدمة الرفع على الـVPS
  // (BookingService.uploadExamImage) — نفس نمط صور المعلّم، لأن مشروع
  // Firebase على خطة Spark ومبيدعمش Storage.
