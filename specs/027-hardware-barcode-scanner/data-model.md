...
|---|---|---|
| `maxAvgGap` | `50ms` | أقصى متوسط زمن/حرف (من أول حرف لعلامة النهاية) ليُعدّ جهازًا |
| `idleReset` | `300ms` | خمول بلا نهاية → تصفير |
| `newSequenceGap` | `250ms` | فجوة بين ضغطتين أكبر منها = تتابع جديد |
